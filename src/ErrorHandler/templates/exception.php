    ...
    <div class="header">
        <div class="tools">
            ...
            <?php if ($throwable instanceof \ErrorException): ?>
                        ...
                        <h1>
                            <span><?= $this->htmlEncode($this->getThrowableName($throwable)) ?></span>
                            &ndash; <?= $this->addTypeLinks(get_class($throwable)) ?>
                        </h1>
                    <?php else: ?>
                        ...
                        <h1><?php
                                ...
                                echo '<span>' . $this->htmlEncode($name) . '</span>';
                                echo ' &ndash; ' . $this->addTypeLinks(get_class($throwable));
                        ?></h1>
                    <?php endif; ?>
